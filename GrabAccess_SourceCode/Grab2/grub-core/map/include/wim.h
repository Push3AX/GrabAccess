...
extern int wim_header ( struct vfat_file *file, struct wim_header *header );
extern int wim_count ( struct vfat_file *file, struct wim_header *header,
		       unsigned int *count );
extern int wim_metadata ( struct vfat_file *file, struct wim_header *header,
			  unsigned int index, struct wim_resource_header *meta);
extern int wim_read ( struct vfat_file *file, struct wim_header *header,
		      struct wim_resource_header *resource, void *data,
		      size_t offset, size_t len );
extern int wim_path ( struct vfat_file *file, struct wim_header *header,
		      struct wim_resource_header *meta, const wchar_t *path,
		      size_t *offset, struct wim_directory_entry *direntry );
extern int wim_file ( struct vfat_file *file, struct wim_header *header,
		      struct wim_resource_header *meta, const wchar_t *path,
		      struct wim_resource_header *resource );
extern int wim_dir_len ( struct vfat_file *file, struct wim_header *header,
