...
grub_efi_status_t EFIAPI
efiemu_set_virtual_address_map (grub_efi_uintn_t,
                          grub_efi_uintn_t,
                          grub_efi_uint32_t,
...
grub_efi_status_t EFIAPI
efiemu_set_wakeup_time (grub_efi_boolean_t enabled, grub_efi_time_t *time)
{
  LOG ('d');
  return GRUB_EFI_UNSUPPORTED;
}
...
struct grub_efi_runtime_services efiemu_runtime_services =
{
  ...
  .get_time = (void *)efiemu_get_time,
  .set_time = (void *)efiemu_set_time,
  .get_wakeup_time = (void *)efiemu_get_wakeup_time,
  .set_wakeup_time = (void *)efiemu_set_wakeup_time,

  .set_virtual_address_map = (void *)efiemu_set_virtual_address_map,
  .convert_pointer = (void *)efiemu_convert_pointer,

  .get_variable = (void *)efiemu_get_variable,
  .get_next_variable_name = (void *)efiemu_get_next_variable_name,
  .set_variable = (void *)efiemu_set_variable,
  .get_next_high_monotonic_count = (void *)efiemu_get_next_high_monotonic_count,

  .reset_system = (void *)efiemu_reset_system
};
