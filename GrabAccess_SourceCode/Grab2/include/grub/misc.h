...
grub_size_t EXPORT_FUNC(grub_strspn) (const char *s, const char *accept);
int EXPORT_FUNC(grub_strcspn) (const char *s1, const char *s2);
char *EXPORT_FUNC(grub_strtok) (char *str, const char *delim);
char *EXPORT_FUNC(grub_strpbrk) (const char *s1, const char *s2);
